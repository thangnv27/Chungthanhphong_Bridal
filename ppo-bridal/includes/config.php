...
//            "type" => "text"),
    ...
    'open-options' => array(
        ...
        array("name" => "RIN Logo",
            "desc" => "",
            "id" => SHORT_NAME . "_rin_logo",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "RIN Logo Hover",
            "desc" => "",
            "id" => SHORT_NAME . "_rin_logo_hover",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "RIN Background",
            "desc" => "",
            "id" => SHORT_NAME . "_rin_bg",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Bridal Logo",
            "desc" => "",
            "id" => SHORT_NAME . "_bridal_logo",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Bridal Logo Hover",
            "desc" => "",
            "id" => SHORT_NAME . "_bridal_logo_hover",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Bridal Background",
            "desc" => "",
            "id" => SHORT_NAME . "_bridal_bg",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("type" => "close"),
        
        array("name" => "Social Options",
            "type" => "title",
            "desc" => "",
        ),
        array("type" => "open"),
        array("name" => "Title",
            "desc" => "Không quá 60 ký tự",
            "id" => SHORT_NAME . "_open_social_title",
            "std" => "",
            "type" => "text"),
        array("name" => "Description",
            "desc" => "Không quá 156 ký tự",
            "id" => SHORT_NAME . "_open_social_description",
            "std" => "",
            "type" => "textarea"),
        array("name" => "Image",
            "desc" => "",
            "id" => SHORT_NAME . "_open_social_image",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("type" => "close"),
